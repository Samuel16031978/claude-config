...
### Session Flow
```
­ƒæÑ Starting pair programming for authentication feature...
...
Ô£à Truth Score: 0.98 - Committed successfully
```
...
### Session Flow
```
­ƒæÑ Starting debugging session...

/status
> Analyzing application for memory issues...

/perf --profile
> Memory usage growing: 150MB ÔåÆ 450MB over 10 minutes
...
### Session Flow
```
­ƒæÑ TDD Session: Shopping Cart Feature

[RED PHASE]
/test-gen "add item to cart"
> AI writes failing test:
  Ô£ù should add item to cart
  Ô£ù should update quantity for existing item
  Ô£ù should calculate total price
...
### Session Flow
```
­ƒæÑ Refactoring Session: Modernizing UserService
...
/test
> All tests passing Ô£à

/review --compare
> AI shows before/after comparison
> Code complexity: 35 ÔåÆ 12
> Truth score: 0.99 Ô£à
...
### Session Flow
```
­ƒæÑ Learning Session: React Hooks
...
### Session Flow
```
­ƒæÑ Performance Optimization Session
...
/perf --profile
> ProductList: 45ms render (90% improvement!) Ô£à

/implement virtualization with react-window
> AI implements virtual scrolling

/perf --profile
> ProductList: 12ms render (97% improvement!) Ô£à
> FPS: 60 stable Ô£à
...
/test --integration
> All endpoints tested: 15/15 Ô£à
...
### Session Flow
```
­ƒæÑ Database Migration Session

/analyze MongoDB schema
> AI maps current structure:
  - users collection ÔåÆ users table
  - posts collection ÔåÆ posts table
  - Embedded comments ÔåÆ comments table with FK
...
> Migration successful for 10,000 records Ô£à

/implement data access layer
> AI creates repository pattern implementation

/test --integration
> All queries working correctly Ô£à

/verify data integrity
> Truth score: 0.995 Ô£à
...
/test --ci --dry-run
> Pipeline simulation successful Ô£à
...
### Session Flow
```
­ƒæÑ Mobile Development Session
...
> Feature working on iOS Ô£à

/test --device android emulator
> Feature working on Android Ô£à
...
```
/start ÔåÆ /explain ÔåÆ /design ÔåÆ /implement ÔåÆ /test ÔåÆ /review ÔåÆ /commit ÔåÆ /end
```

#### Typical Bug Fix
```
/start ÔåÆ /reproduce ÔåÆ /debug ÔåÆ /trace ÔåÆ /fix ÔåÆ /test ÔåÆ /verify ÔåÆ /commit ÔåÆ /end
```

#### Typical Refactoring
```
/start ÔåÆ /analyze ÔåÆ /plan ÔåÆ /test-gen ÔåÆ /refactor ÔåÆ /test ÔåÆ /review ÔåÆ /commit ÔåÆ /end
```
