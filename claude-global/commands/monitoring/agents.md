...
## Important Reminders
-  This tool provides coordination and structure
-  Claude Code performs all actual implementation
- ﯔ The tool does NOT write code
- ﯔ The tool does NOT access files directly
- ﯔ The tool does NOT execute commands
