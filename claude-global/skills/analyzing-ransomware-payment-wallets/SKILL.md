...
Victim Payment ÔöÇÔöÇÔû║ Ransom Wallet ÔöÇÔöÇÔû║ Consolidation Wallet
                                  Ôö£ÔöÇÔû║ Mixer/Tumbler Service
                                  Ôö£ÔöÇÔû║ Exchange Deposit Address
                                  ÔööÔöÇÔû║ Peel Chain (sequential small outputs)
...
FUND FLOW:
  Payment 1: 1.5 BTC ÔåÆ Consolidation wallet ÔåÆ Binance deposit
  Payment 2: 1.0 BTC ÔåÆ Wasabi Mixer ÔåÆ Unknown
  Payment 3: 1.75 BTC ÔåÆ Peel chain (12 hops) ÔåÆ OKX deposit
