# Vendor Risk Assessment ÔÇö Worked Example
...
- **Business criticality:** High ÔÇö a multi-day outage would block payroll.
...
- **ISO 27001:** Certificate obtained ÔÇö scope statement confirmed to cover the payroll service.
...
| Two critical fourth parties (cloud + email) | Info | Concentration noted (see ┬º8) |

> The SOC 2 cover page was clean ÔÇö the exception was found in the body. Always read the deviations and CUECs.

## 5. Decision & Residual Risk
- **Decision:** **Approve ÔÇö Conditional.**
...
- **Concentration risk:** our HRIS and PayWorks both ride the same cloud region ÔÇö a single regional outage hits payroll and HR together. Contingency: documented manual-payroll fallback for one cycle.
