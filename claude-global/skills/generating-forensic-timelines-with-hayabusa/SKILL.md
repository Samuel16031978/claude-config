...
A frequent finding in Hayabusa timelines is malicious PowerShell ÔÇö MITRE ATT&CK **T1059.001 (Command and Scripting Interpreter: PowerShell)** ÔÇö surfaced via Sigma rules over Event ID 4104 (script-block logging), 4103, and Sysmon process creation. This skill maps to NIST CSF **RS.AN-03** (analysis is performed to establish what has taken place during an incident).
...
| Takaj┼ì | Hayabusa results analyzer | https://github.com/Yamato-Security/takajo |
