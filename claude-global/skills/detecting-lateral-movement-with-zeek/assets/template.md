...
| **Date/Time Detected** | |
| **Analyst** | |
| **Detection Source** | Zeek ÔÇö lateral movement detection |
| **Severity** | ÔÿÉ Critical ÔÿÉ High ÔÿÉ Medium ÔÿÉ Low |
...
- [ ] Any evidence of data exfiltration: ÔÿÉ Yes ÔÿÉ No ÔÿÉ Unknown
