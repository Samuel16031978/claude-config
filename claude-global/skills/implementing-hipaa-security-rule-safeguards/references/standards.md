# HIPAA Security Rule ÔÇö Standards & Reference

## Primary regulation
### HIPAA Security Rule ÔÇö 45 CFR Part 164, Subpart C
...
| Section | Title |
|---|---|
| ┬º164.302 | Applicability |
| ┬º164.304 | Definitions |
| ┬º164.306 | Security standards: general rules (flexibility, scalability) |
| ┬º164.308 | **Administrative safeguards** |
| ┬º164.310 | **Physical safeguards** |
| ┬º164.312 | **Technical safeguards** |
| ┬º164.314 | Organizational requirements (BAAs, group health plans) |
| ┬º164.316 | Policies, procedures, and documentation (6-year retention) |

Breach Notification Rule: **45 CFR ┬º┬º164.400ÔÇô414** (Subpart D).

## Administrative safeguards (┬º164.308) ÔÇö standards
- Security Management Process ÔÇö **Risk Analysis (R)**, **Risk Management (R)**, Sanction Policy (R), Information System Activity Review (R)
- Assigned Security Responsibility (named Security Official)
- Workforce Security (authorization/supervision, clearance, termination ÔÇö Addressable)
- Information Access Management (isolating clearinghouse functions (R); access authorization/establishment/modification ÔÇö Addressable)
- Security Awareness and Training (reminders, malware protection, log-in monitoring, password management ÔÇö Addressable)
- Security Incident Procedures ÔÇö Response and Reporting (R)
- Contingency Plan ÔÇö **Data Backup Plan (R)**, **Disaster Recovery Plan (R)**, **Emergency Mode Operation Plan (R)**, Testing/Revision (A), Applications/Data Criticality Analysis (A)
- Evaluation (periodic)
- Business Associate Contracts (┬º164.308(b))

## Physical safeguards (┬º164.310) ÔÇö standards
- Facility Access Controls (contingency operations, facility security plan, access control/validation, maintenance records ÔÇö all Addressable)
- Workstation Use (R)
- Workstation Security (R)
- Device and Media Controls ÔÇö **Disposal (R)**, **Media Re-use (R)**, Accountability (A), Data Backup and Storage (A)

## Technical safeguards (┬º164.312) ÔÇö standards
- Access Control ÔÇö **Unique User Identification (R)**, **Emergency Access Procedure (R)**, Automatic Logoff (A), Encryption and Decryption (A)
- Audit Controls (R)
- Integrity ÔÇö Mechanism to Authenticate ePHI (A)
- Person or Entity Authentication (R)
- Transmission Security ÔÇö Integrity Controls (A), Encryption (A)
...
## Breach Notification (45 CFR ┬º┬º164.400ÔÇô414)
...
## 2025 NPRM ÔÇö PROPOSED changes (NOT yet final)
...
- **Notable proposals**:
  - Remove the **required/addressable** distinction ÔÇö make (nearly) all implementation specifications **required**.
