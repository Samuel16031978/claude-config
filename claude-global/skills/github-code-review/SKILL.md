...
# Post review status
gh pr comment 123 --body "­ƒöì Multi-agent code review initiated"
```
...
**Benefits:**
- Ô£à Parallel review by specialized agents
- Ô£à Comprehensive coverage across multiple domains
- Ô£à Faster review cycles with coordinated analysis
- Ô£à Consistent quality standards enforcement

---

## ­ƒñû Specialized Review Agents
...
```markdown
­ƒöÆ **Security Issue: [Type]**

**Severity**: ­ƒö┤ Critical / ­ƒƒí High / ­ƒƒó Low
...
## ­ƒÆ¼ Intelligent Comment Generation
...
## ­ƒôï Complete Workflow Examples
...
- Ô£à Define clear review criteria upfront
- Ô£à Set appropriate severity thresholds
- Ô£à Configure agent specializations for your stack
- Ô£à Establish override procedures for emergencies

### 2. Comment Quality
- Ô£à Provide actionable, specific feedback
- Ô£à Include code examples with suggestions
- Ô£à Reference documentation and best practices
- Ô£à Maintain respectful, constructive tone

### 3. Performance Optimization
- Ô£à Cache analysis results to avoid redundant work
- Ô£à Use incremental reviews for large PRs
- Ô£à Enable parallel agent execution
- Ô£à Batch comment operations efficiently
...
## ­ƒöù Integration with Claude Code
