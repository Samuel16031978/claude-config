...
claude-flow pair --start \
  ...
  --coverage 100
```
Workflow: Write failing test ÔåÆ Implement ÔåÆ Refactor ÔåÆ Repeat
...
­ƒôè Metrics:
Ôö£ÔöÇÔöÇ Truth Score: 0.982 Ô£à
Ôö£ÔöÇÔöÇ Lines Changed: 234
Ôö£ÔöÇÔöÇ Files Modified: 5
Ôö£ÔöÇÔöÇ Tests Added: 12
Ôö£ÔöÇÔöÇ Coverage: 87% Ôåæ3%
ÔööÔöÇÔöÇ Commits: 3

­ƒÄ» Focus: Implementation
­ƒôØ Current File: src/auth/login.js
```
...
Navigate history:
- `Ôåæ/Ôåô` - Navigate through command history
