...
|--------------|----------------|-----------|
| T1542.003 | Pre-OS Boot: Bootkit | Core technique  bootkit subverts the boot chain below the OS. |
