...
- *"give me a few ways toÔÇª"*, *"brainstormÔÇª"*, *"what are some approaches"*
...
3. **Converge.** A 2 to 4 idea shortlist. State why each is on the list.
   Mark the non-obvious-but-viable pick explicitly with Ôÿà. List traps
...
- **How many ideas?** Scale to stakes. Quick "name this function" =
  3 frames ├ù 4 ideas. "How should I position this product" = 5 frames ├ù
  8 ideas. Default is 5 ├ù 6 = 30.
...
5 diverge + 1 score + 1 cluster + 3 deepen Ôëê 10 Agent calls per run.
