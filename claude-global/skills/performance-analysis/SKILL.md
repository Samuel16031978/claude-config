...
#### Output Format
```
­ƒöì Bottleneck Analysis Report
ÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöüÔöü

­ƒôè Summary
Ôö£ÔöÇÔöÇ Time Range: Last 1 hour
Ôö£ÔöÇÔöÇ Agents Analyzed: 6
Ôö£ÔöÇÔöÇ Tasks Processed: 42
ÔööÔöÇÔöÇ Critical Issues: 2

­ƒÜ¿ Critical Bottlenecks
1. Agent Communication (35% impact)
   ÔööÔöÇÔöÇ coordinator ÔåÆ coder-1 messages delayed by 2.3s avg

2. Memory Access (28% impact)
   ÔööÔöÇÔöÇ Neural pattern loading taking 1.8s per access

ÔÜá´©Å Warning Bottlenecks
1. Task Queue (18% impact)
   ÔööÔöÇÔöÇ 5 tasks waiting > 10s for assignment
...
|--------|-------|-------|--------|
| Avg Task Time | 42s | Ôåô 12% | 35s |
| Agent Utilization | 78% | Ôåæ 5% | 85% |
| Cache Hit Rate | 91% | ÔåÆ | 90% |
| Parallel Efficiency | 2.3x | Ôåæ 0.4x | 2.5x |

## Bottleneck Analysis
### Critical
1. **Agent Communication Delay** (Impact: 35%)
   - Coordinator ÔåÆ Coder messages delayed by 2.3s avg
...
- Switch to more efficient topology (mesh ÔåÆ hierarchical)
