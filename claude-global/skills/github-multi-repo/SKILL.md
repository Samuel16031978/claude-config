...
[Cross-Package Feature]:
  ...
  Bash(`gh pr create \
    ...
    --body "## ­ƒÜÇ GitHub Integration

### Features
- Ô£à Multi-repo coordination
- Ô£à Package synchronization
- Ô£à Architecture optimization
...
Part of #$TRACKING_ISSUE"
      ...
      gh issue comment $TRACKING_ISSUE \
        --body "ÔØî Failed to update $repo - tests failing"
    fi
  done`)
```
...
ruv-FANN/
Ôö£ÔöÇÔöÇ packages/
Ôöé   Ôö£ÔöÇÔöÇ claude-code-flow/
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ src/
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ .claude/
Ôöé   Ôöé   ÔööÔöÇÔöÇ package.json
Ôöé   Ôö£ÔöÇÔöÇ ruv-swarm/
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ src/
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ wasm/
Ôöé   Ôöé   ÔööÔöÇÔöÇ package.json
...
.claude/
Ôö£ÔöÇÔöÇ commands/
Ôöé   Ôö£ÔöÇÔöÇ github/
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ github-modes.md
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ pr-manager.md
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ issue-tracker.md
Ôöé   Ôöé   ÔööÔöÇÔöÇ sync-coordinator.md
Ôöé   Ôö£ÔöÇÔöÇ sparc/
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ sparc-modes.md
Ôöé   Ôöé   Ôö£ÔöÇÔöÇ coder.md
Ôöé   Ôöé   ÔööÔöÇÔöÇ tester.md
Ôöé   ÔööÔöÇÔöÇ swarm/
Ôöé       Ôö£ÔöÇÔöÇ coordination.md
Ôöé       ÔööÔöÇÔöÇ orchestration.md
Ôö£ÔöÇÔöÇ templates/
Ôöé   Ôö£ÔöÇÔöÇ issue.md
Ôöé   Ôö£ÔöÇÔöÇ pr.md
