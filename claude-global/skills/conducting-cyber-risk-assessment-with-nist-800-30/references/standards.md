# NIST SP 800-30 ÔÇö Standards & Reference

## Primary standard
### NIST SP 800-30 Revision 1 ÔÇö Guide for Conducting Risk Assessments
- **Publisher**: NIST
...
| Document | Role |
|---|---|
| NIST SP 800-39 | Managing Information Security Risk ÔÇö three-tier context (Tier 1 organization, Tier 2 mission/business process, Tier 3 information system). |
| NIST SP 800-37 Rev 2 | Risk Management Framework ÔÇö risk assessment feeds the Prepare, Select, and Authorize steps. |
| NIST SP 800-53 Rev 5 | Control catalog ÔÇö source of mitigating controls chosen in risk treatment. |
...
1. **Prepare** ÔÇö purpose, scope, assumptions/constraints, sources, risk model and scales.
2. **Conduct** ÔÇö tasks 2aÔÇô2f below.
3. **Communicate** ÔÇö risk register + briefing.
4. **Maintain** ÔÇö monitoring and refresh.
...
- **Adversarial** ÔÇö individuals, groups, organizations, nation-states. Characterize by capability, intent, and targeting.
- **Accidental** ÔÇö erroneous actions by authorized users.
- **Structural** ÔÇö failures of equipment, software, or environmental controls.
- **Environmental** ÔÇö natural or man-made disasters, infrastructure outages.

## Assessment scales (qualitative / semi-quantitative)
800-30 uses five-level scales. A common qualitative mapping:

| Level | Semi-quantitative (0ÔÇô10) |
|---|---|
| Very Low | 0ÔÇô4 |
| Low | 5ÔÇô20 |
| Moderate | 21ÔÇô79 |
...
### Reference 5├ù5 risk matrix (likelihood ├ù impact ÔåÆ risk)
| Likelihood Ôåô / Impact ÔåÆ | Very Low | Low | Moderate | High | Very High |
|---|---|---|---|---|---|
...
- **Mitigate** ÔÇö implement/strengthen controls (re-score residual risk).
- **Transfer** ÔÇö insurance or contractual shift.
- **Avoid** ÔÇö discontinue the risk-generating activity.
- **Accept** ÔÇö document residual risk with an authorizing signature within risk tolerance.
