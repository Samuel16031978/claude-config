...
- **Examples**:
  - Ô£à "API Documentation Generator"
  - Ô£à "React Component Builder"
  - Ô£à "Database Schema Designer"
  - ÔØî "skill-1" (not descriptive)
  - ÔØî "This is a very long skill name that exceeds sixty-four characters" (too long)
...
- **Examples**:
  - Ô£à "Generate OpenAPI 3.0 documentation from Express.js routes. Use when creating API docs, documenting endpoints, or building API specifications."
  - Ô£à "Create React functional components with TypeScript, hooks, and tests. Use when scaffolding new components or converting class components."
  - ÔØî "A comprehensive guide to API documentation" (no "when" clause)
  - ÔØî "Documentation tool" (too vague)

#### YAML Formatting Rules

```yaml
---
# Ô£à CORRECT: Simple string
name: "API Builder"
description: "Creates REST APIs with Express and TypeScript."

# Ô£à CORRECT: Multi-line description
...
ÔööÔöÇÔöÇ my-skill/                        # Skill directory (MUST be at top level!)
    ÔööÔöÇÔöÇ SKILL.md                     # REQUIRED: Main skill file
```
...
```
~/.claude/skills/
ÔööÔöÇÔöÇ my-skill/                        # Top-level skill directory
        Ôö£ÔöÇÔöÇ SKILL.md                 # REQUIRED: Main skill file
        Ôö£ÔöÇÔöÇ README.md                # Optional: Human-readable docs
        Ôö£ÔöÇÔöÇ scripts/                 # Optional: Executable scripts
        Ôöé   Ôö£ÔöÇÔöÇ setup.sh
        Ôöé   Ôö£ÔöÇÔöÇ validate.js
        Ôöé   ÔööÔöÇÔöÇ deploy.py
        Ôö£ÔöÇÔöÇ resources/               # Optional: Supporting files
        Ôöé   Ôö£ÔöÇÔöÇ templates/
        Ôöé   Ôöé   Ôö£ÔöÇÔöÇ api-template.js
        Ôöé   Ôöé   ÔööÔöÇÔöÇ component.tsx
        Ôöé   Ôö£ÔöÇÔöÇ examples/
        Ôöé   Ôöé   ÔööÔöÇÔöÇ sample-output.json
        Ôöé   ÔööÔöÇÔöÇ schemas/
        Ôöé       ÔööÔöÇÔöÇ config-schema.json
        ÔööÔöÇÔöÇ docs/                    # Optional: Additional documentation
            Ôö£ÔöÇÔöÇ ADVANCED.md
            Ôö£ÔöÇÔöÇ TROUBLESHOOTING.md
            ÔööÔöÇÔöÇ API_REFERENCE.md
```
...
### ­ƒÄ» Progressive Disclosure Architecture
...
### ­ƒôØ SKILL.md Content Structure
...
### ­ƒÄ¿ Content Best Practices

#### Writing Effective Descriptions

**Front-Load Keywords**:
```yaml
# Ô£à GOOD: Keywords first
...
# ÔØî BAD: No trigger conditions
description: "Helps with React performance debugging."
```

**Be Specific**:
```yaml
# Ô£à GOOD: Specific technologies
...
### ­ƒøá´©Å Adding Scripts and Resources
...
# In skill directory
scripts/
Ôö£ÔöÇÔöÇ setup.sh          # Initialization script
Ôö£ÔöÇÔöÇ validate.js       # Validation logic
Ôö£ÔöÇÔöÇ generate.py       # Code generation
ÔööÔöÇÔöÇ deploy.sh         # Deployment script
```
...
resources/
Ôö£ÔöÇÔöÇ templates/
Ôöé   Ôö£ÔöÇÔöÇ component.tsx.template
Ôöé   Ôö£ÔöÇÔöÇ test.spec.ts.template
Ôöé   ÔööÔöÇÔöÇ story.stories.tsx.template
Ôö£ÔöÇÔöÇ examples/
Ôöé   Ôö£ÔöÇÔöÇ basic-example/
Ôöé   Ôö£ÔöÇÔöÇ advanced-example/
Ôöé   ÔööÔöÇÔöÇ integration-example/
ÔööÔöÇÔöÇ schemas/
    Ôö£ÔöÇÔöÇ config.schema.json
    ÔööÔöÇÔöÇ output.schema.json
```
...
### ­ƒöù File References and Navigation
