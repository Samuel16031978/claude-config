# Standards and References ÔÇö Detecting Model Extraction Attacks
...
| AML.T0024.000 | Infer Training Data Membership | Exfiltration | Membership inference ÔÇö determine if a record was in the training set (privacy leak). |
| AML.T0024.001 | Invert AI Model | Exfiltration | Model inversion ÔÇö reconstruct training inputs from confidence scores. |
| AML.T0024.002 | Extract ML Model | Exfiltration | Model stealing ÔÇö train a surrogate from query/response pairs to clone the model. |
...
- Tram├¿r et al., "Stealing Machine Learning Models via Prediction APIs" (USENIX Security 2016)
