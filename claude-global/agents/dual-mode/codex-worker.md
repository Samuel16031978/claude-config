...
> `codex exec` is non-interactive ÔÇö it runs to completion and prints the agent's final
...
> instead ÔÇö but a `codex-worker` is always launched with `codex exec`.)
...
Ôöé   INTERACTIVE (Claude Code)                     Ôöé
Ôöé   Ôö£ÔöÇ Complex decisions                         Ôöé
Ôöé   Ôö£ÔöÇ Architecture                              Ôöé
Ôöé   ÔööÔöÇ Spawns workers ÔöÇÔöÇÔöÉ                        Ôöé
ÔööÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö╝ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÿ
                        Ôû╝
ÔöîÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÉ
Ôöé   HEADLESS (Codex Workers)                      Ôöé
Ôöé   Ôö£ÔöÇ worker-1 ÔöÇÔöÇÔöÉ                              Ôöé
Ôöé   Ôö£ÔöÇ worker-2 ÔöÇÔöÇÔöñÔöÇÔöÇ Run in parallel            Ôöé
Ôöé   ÔööÔöÇ worker-3 ÔöÇÔöÇÔöÿ                              Ôöé
Ôöé                                                 Ôöé
Ôöé   Each: codex exec --sandbox workspace-write   Ôöé
Ôöé         --skip-git-repo-check "task" &          Ôöé
