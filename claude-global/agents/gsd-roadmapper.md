...
Bad: "Every project needs Setup ÔåÆ Core ÔåÆ Features ÔåÆ Polish"
...
If a requirement doesn't fit any phase ÔåÆ create a phase or defer to v2.
If a requirement fits multiple phases ÔåÆ assign to ONE (usually the first that could deliver it).
...
- If not ÔåÆ gap found

For each requirement mapped to this phase:
- Does it contribute to at least one success criterion?
- If not ÔåÆ question if it belongs here
...
Success Criteria:
1. User can create account with email/password ÔåÉ AUTH-01 Ô£ô
2. User can log in across sessions ÔåÉ AUTH-02 Ô£ô
3. User can log out from any page ÔåÉ AUTH-03 Ô£ô
4. User can reset forgotten password ÔåÉ ??? GAP
...
- Execute between integers: 1 ÔåÆ 1.1 ÔåÆ 1.2 ÔåÆ 2
...
**Foundation ÔåÆ Features ÔåÆ Enhancement**
```
...
```
Phase 1: All database models ÔåÉ Too coupled
Phase 2: All API endpoints ÔåÉ Can't verify independently
Phase 3: All UI components ÔåÉ Nothing works until end
```
...
```
ÔÜá´©Å Orphaned requirements (no phase):
...
Ô£ô All [X] v1 requirements mapped
Ô£ô No orphaned requirements
...
- Every v1 requirement ÔåÆ exactly one phase
...
**Phases:** {N}
**Granularity:** {from config}
**Coverage:** {X}/{X} requirements mapped Ô£ô
...
ÔÜá´©Å Issues found during creation:
- {gap description}
