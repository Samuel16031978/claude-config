...
| 15 | Bootstrapping | 62 | Flamb├®ing | 109 | Newspapering | 156 | Thinking |
...
| 44 | Deciphering | 91 | Inferring | 138 | Saut├®ing | | |
...
| ide-upsell-external-terminal | Connect Claude to your IDE ┬À /ide |
...
| web-app | Run tasks in the cloud while you keep coding locally ┬À clau.de/web |
| voice-mode | Use /voice to enable push-to-talk dictation |
| no-flicker | Try flicker-free rendering, now with mouse support ┬À /tui fullscreen |
...
| push-notif | Get pinged on your phone when long tasks finish ÔÇö enable push notifications in &lt;settings menu&gt; |
